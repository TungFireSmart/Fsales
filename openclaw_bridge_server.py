...
def _call_openclaw_agent(message: str, user: str) -> str:
    # Tách session theo từng user FSales để không lẫn ngữ cảnh chat.
    # Ví dụ: agent:main:fsales-phone-098...
    session_suffix = _safe_session_suffix(user)
    session_id = f"agent:main:fsales-{session_suffix}"
